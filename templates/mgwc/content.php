...
<section class="content">
	<div class="container">
		...
		<div class="row" style="position: relative;">
			<div id="map-canvas">
				<div class="row map-menu" style="display: none;" id="map-menu-at-scroll">
					<div>
						<div class="col-xs-12">
							<div class="map-menu-buttons"><label><input type="checkbox" name="mmap_category[]"
																													value="4"/>&nbsp;Club</label></div>
							<div class="map-menu-buttons"><label><input type="checkbox" name="mmap_category[]" value="2"/>&nbsp;Eventi</label>
							</div>
							<div class="map-menu-buttons"><label><input type="checkbox" name="mmap_category[]" value="5"/>&nbsp;Soccorso
									Aquila</label></div>
							<div class="map-menu-buttons"><label><input type="checkbox" name="mmap_category[]" value="3"/>&nbsp;Dealer</label>
							</div>
							<div class="map-menu-return"><span class="glyphicon glyphicon-remove" rel="tooltip"
																								 title="Chiudi mappa!"></span></div>
						</div>
						<div class="col-xs-12">
							<div class="map-menu-search">
								...
								<input type="hidden" name="mapi_csrf" id="mapi_csrf"
											 value="<?php MPut::_html_attr(mapi_csrf_value()); ?>"/>
			...
			<div id="content" style="position: relative; top: -80px; z-index: 1000; ">
				<div class="row">
					...
					<div class="col-md-8 col-sm-12 content-container">
						...
						<div class="content-social">
							<?php $this->widget('share', '7869131cea409f5b7ead43707e6cbba3'); ?>
						</div>
						<?php
							$Types = array('post', 'event');
							$this->widget('disqus', array($Types));
						?>
					</div>
		...
		<div class="row" id="box-images" style="margin-left: -14px;">
			<?php $this->widget('box', array('media/images/box_storia.jpg', 'TRADIZIONE', 'NOBLE DYNASTY FOR OVER 90 YEARS',
																			 'http://www.motoguzzi.com/en/tradizione')); ?>

			<?php $this->widget('box', array('media/images/box_garage.jpg', 'GARAGE', 'BORN WITH STYLE TO LIVE ON PASSION',
																			 'http://www.motoguzzi.com/en/garage')); ?>

			<?php $this->widget('box', array('media/images/literaryCorner.jpg', 'LIBRARY', 'LITERARY CORNER OF GUZZISTA',
																			 'http://motoguzziworldclub.it/mapi/index.php?module=category&object=9')); ?>
		</div>
