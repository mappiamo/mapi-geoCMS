...
<div class="m-content-header">
		<h3 class="hidden-xs hidden-sm"><span class="glyphicon glyphicon-edit"></span> <?php MPut::_title( $data->title ); ?> <span class="badge"><?php MPut::_id( $data->hits ); ?></span></h3>
</div>
...
<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div class="row">
										<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
												...
												<div class="input-group">
														...
														<input type="text" name="content_title" class="form-control" id="content_title" value="<?php MPut::_html_attr( $data->title ); ?>" />
												</div>
										...
										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
																		...
																		<ul class="list-group">
																				<?php foreach ( $data->categories as $category ): ?>
																						<li class="list-group-item">
																								...
																								<button type="button" class="btn btn-xs btn-action" onclick=<?php MPut::_js( 'new MContent().remove_category( \'' . $category->id . '\' );' ); ?> style="float: right;">Remove</button>
																						</li>
																				<?php endforeach; ?>
																		</ul>
																<?php endif; ?>
												...
												<div class="panel panel-default">
														...
														<div class="panel-body">
																<input type="checkbox" name="content_enabled" id="content_enabled" <?php if ( 1 == $data->enabled ) echo 'checked="checked"'; ?> value="1" />
																<label>Enabled</label>
														</div>
												</div>
												...
												<div class="panel panel-default">
														...
														<div class="panel-body">
																<select name="content_language" class="form-control input-sm" id="content_add_translation">
																		<option value="hr" <?php if ( "hr" == $data->language ) echo 'selected="selected"'; ?>>Croatian</option>
																		<option value="da" <?php if ( "da" == $data->language ) echo 'selected="selected"'; ?>>Danish</option>
																		<option value="nl" <?php if ( "nl" == $data->language ) echo 'selected="selected"'; ?>>Dutch</option>
																		<option value="en" <?php if ( "en" == $data->language ) echo 'selected="selected"'; ?>>English</option>
																		<option value="fr" <?php if ( "fr" == $data->language ) echo 'selected="selected"'; ?>>French</option>
																		<option value="de" <?php if ( "de" == $data->language ) echo 'selected="selected"'; ?>>German</option>
																		<option value="gr" <?php if ( "gr" == $data->language ) echo 'selected="selected"'; ?>>Greece</option>
																		<option value="hu" <?php if ( "hu" == $data->language ) echo 'selected="selected"'; ?>>Hungarian</option>
																		<option value="it" <?php if ( "it" == $data->language ) echo 'selected="selected"'; ?>>Italian</option>
																		<option value="ru" <?php if ( "ru" == $data->language ) echo 'selected="selected"'; ?>>Russian</option>
																		<option value="sr" <?php if ( "sr" == $data->language ) echo 'selected="selected"'; ?>>Serbian</option>
																		<option value="si" <?php if ( "si" == $data->language ) echo 'selected="selected"'; ?>>Slovenian</option>
																		<option value="sv" <?php if ( "sv" == $data->language ) echo 'selected="selected"'; ?>>Swedish</option>
																</select>
																
																<br />
																
																<button type="button" onclick="location.href='index.php?module=mcontent&task=content_add_translation&object=<?php MPut::_numeric( $data->id ); ?>&language='+document.getElementById('content_add_translation').options[document.getElementById('content_add_translation').selectedIndex].value;" class="btn btn-sm">Add (Edit) Translation</button>
														</div>
												</div>
								...
								<div class="row">
										<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
												...
												<div class="input-group">
														...
														<input type="text" name="content_address" class="form-control" id="content_address" value="<?php MPut::_html_attr( $data->address ); ?>" />
												</div>
												...
												<?php 
														if ( is_array( $data->media ) && sizeof( $data->media ) > 0 ) {
																foreach ( $data->media as $media ) {
																		$media->text = '';
																		$media->text .= '<div style="float: left; margin-top: 12px; margin-bottom: 12px;"><img class="media-object" style="width: 80px;" src="' . $media->url . '" alt="" /></div>';
																		$media->text .= '<div style="float: left; margin-top: 12px; margin-left: 12px;">';
																				...
																				if ( 1 == $media->default_media ) $media->text .= '<div><code class="green">Default</code></div>';
																		$media->text .= '</div>';
																		$media->text .= '<div style="clear: both;"></div>';
																}

																MHTML::list_group( $data->media, 'title', array( 'Set as default' => 'new MContent().default_media( \'*[id]\' );', 'Delete' => 'new MContent().remove_media( \'*[id]\' );' ) );
														} else {
																?>
																		<div class="panel panel-default">
				...
				<div class="btn-group" style="position: absolute;">
						<button type="button" class="btn btn-default" onclick="location.href='index.php?module=mcontent&task=content_delete&object=<?php MPut::_numeric( $data->id ); ?>';">Delete</button>
